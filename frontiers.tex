...
\def\firstAuthorLast{Dunbar and Dupoux}
\def\Authors{Ewan Dunbar$^{*}$ and Emmanuel Dupoux}
% Affiliations should be keyed to the author's name with superscript numbers and be listed as follows: Laboratory, Institute, Department, Organization, City, State abbreviation (USA, Canada, Australia), and Country (without detailed address information such as city zip codes or street names).
% If one of the authors has a change of address, list the new address below the correspondence details using a superscript symbol and use the same symbol to indicate the author in the author list.
\def\Address{Laboratoire de Sciences Cognitives et Psycholinguistique (ENS--EHESS--CNRS), D\'epartement des \'Etudes Cognitives, \'Ecole Normale Sup\'erieure--PSL Research University, Paris, France}
% The Corresponding Author should be marked with an asterisk
% Provide the exact contact address (this time including street name and city zip code) and email of the corresponding author
\def\corrAuthor{Ewan Dunbar}
\def\corrAddress{Laboratoire de Sciences Cognitives et Psycholinguistique (ENS--EHESS--CNRS, D\'epartement des \'Etudes Cognitives, \'Ecole Normale Sup\'erieure--PSL Research University, Pavillon jardin, 29 rue d'Ulm, Paris 75004, France}
\def\corrEmail{emd@umd.edu}
...
\title[Symmetry in speech sounds]{The influence of symmetry on speech sounds}
...
\section{}
The speech sounds of human languages have been long been conjectured to influence each other
so that, if a language has one sound, it will also tend to have the ``opposite'' sound
according to a set of universal phonetic dimensions. This tendency has
sometimes been explained by the postulate that the cognitive systems that store and retrieve
words in memory are based primarily around these phonetic dimensions, (consonant voicing,
vowel height, and so on), rather than a representation closer to the auditory signal. Based
on analysis of a large database of languages, we show that this tenden
\tiny
